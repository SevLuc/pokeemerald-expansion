...
| MISTY-16 | Misty (readiness gate, via PSYDUCK only) | Policeman blocking the robbed-house shortcut turns the player back: the sealed way is "stubborn, dazed, won't be moved… like a certain PSYDUCK I could name," and dares them to get the better of "one THAT bullheaded" before the door opens. Never names MISTY/gym/badge; the gate is inferred through the duck. Blocking branch on the SAME Cerulean Policeman as MISTY-10. | Cerulean Policeman (existing; pre-Cascade blocking branch) | Cerulean City | before FLAG_BADGE02_GET (Cascade) | 6 | drafted | - |
...
| LOCKE-01 | Locke (Ep. 1, Oak's Lab) | Battle voice: "goes live," casts the rivalry as his series, greets you as the best thing to happen to the channel; spins the tutorial loss as episode-one content AND his first thank-you. Bright, generous, no shadow yet. Full 4-string set (earlyrival: INTRO/DEFEAT/VICTORY/POST) ready in locke.md "Full rival dialogue (READY TO WIRE)". | Locke | Pallet, Oak's Lab | starter pick | 1 | drafted (ready to wire) | [FLAG: release-swap] |
| LOCKE-02 | Locke (Route 22 early) | Battle voice: show on the road; hypes YOU at the camera, celebrates the loss as your win, thanks you and urges the audience to go play too. All warmth. Full 4-string set (earlyrival) ready in locke.md "Full rival dialogue (READY TO WIRE)". | Locke | Route 22 | none (early) | 2 | drafted (ready to wire) | [FLAG: release-swap] |
| LOCKE-03 | Locke (Cerulean) | Battle voice: brags the roster's growing but pivots to hyping YOURS and telling chat they're why he does this. Still glowing; the first faint "…right?" undertone surfaces here. Full 3-string set (no_intro: INTRO/DEFEAT/POST, Bill nudge folded into POST) ready in locke.md "Full rival dialogue (READY TO WIRE)". | Locke | Cerulean City | after robbed house | 3 | drafted (ready to wire) | [FLAG: release-swap] |
| LOCKE-04 | Locke (S.S. Anne) | Battle voice: "luxury episode"; sells the deathless brand but folds YOU into it ("you belong on this deck") and thanks you for a gorgeous fight, over-warm insistence. Generous host energy. Full 3-string set (no_intro, CUT nudge in POST) ready in locke.md "Full rival dialogue (READY TO WIRE)". | Locke | S.S. Anne 2F Corridor | story (ship) | 4 | drafted (ready to wire) | [FLAG: release-swap] |
| LOCKE-05 | Locke (Pokemon Tower) THE GLIMPSE | Battle voice: preaches the sacred fear of permadeath in a graveyard, then wonders aloud if anyone would be there to see his mons fall. The one faint-ache surface; played STRAIGHT, but his gratitude (thanks the player, thanks chat for staying) carries the page, not hollowness. Full 3-string set (no_intro), no joke on any of the three strings, ready in locke.md "Full rival dialogue (READY TO WIRE)". | Locke | Pokemon Tower 2F | story (Lavender) | 5 | drafted (ready to wire) | [FLAG: release-swap] |
| LOCKE-06 | Locke (Silph Co.) | Battle voice: channel's gone quiet ("the light's just blinking red"), keeps going anyway because he LOVES this, not because he's empty; calls the player a joy to film. Love of the game carries him; warm, quietly brave. Full 3-string set (no_intro, Giovanni nudge in POST) ready in locke.md "Full rival dialogue (READY TO WIRE)". | Locke | Silph Co. 7F | story (Saffron) | 6 | drafted (ready to wire) | [FLAG: release-swap] |
| LOCKE-07 | Locke (Route 22 late) | Battle voice: all eight badges, deathless as promised, and he is PROUD of you, ready to hype the big one; a faint "even if the room's quiet" spent on encouraging you to go be champion. Warmth load-bearing. Full 4-string set (earlyrival) ready in locke.md "Full rival dialogue (READY TO WIRE)". | Locke | Route 22 | all badges | 7 | drafted (ready to wire) | [FLAG: release-swap] |
| LOCKE-08 | Locke (Champion) THE LANDING | Battle voice: thanks whoever's watching for the whole run and for playing at all, thanks the player most; on the loss calls it a wrap, hands the run to YOU, tells you to get others to start theirs, and lands it warm ("Somebody's gotta remember this game, and I'm so glad it's you"). Gives Oak's fixed "love and trust" capstone a SOFT target (love ran to the record/audience more than the bond in hand). Full 3-string set (no_intro); POST-BATTLE ends on a graceful handoff into Oak's untouched capstone. Ready in locke.md "Full rival dialogue (READY TO WIRE)". | Locke | Indigo Plateau, Champion's Room | story (Champion) | 8 | drafted (ready to wire) | [FLAG: release-swap] |
| LOCKE-09 | Locke (rematch, post-game) | Battle voice: the channel never ends and he's delighted; back filming and thanking everyone, a re-run he loves too much to stop. Warmth up front, ache faint, showman intact. Full 3-string set (no_intro) ready in locke.md "Full rival dialogue (READY TO WIRE)". | Locke | Indigo Plateau, Champion's Room | post-game rematch | 9 | drafted (ready to wire) | [FLAG: release-swap] |
