...
| MISTY-07 | Misty (gimmick) | Bug-ban gate: on gym entry, if any party mon is BUG type you're stopped ("she's up on a chair for the afternoon") and bounced back to the city door. New special PartyHasBugType + ON_FRAME map script; always-on. | Gym entry (guide voice) | Cerulean Gym | none | 7 | in-game | - |
