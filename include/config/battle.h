...
#define B_AFFECTION_MECHANICS           FALSE      // In Gen6+, there's a stat called affection that can trigger different effects in battle. From LGPE onwards, those effects use friendship instead. Disabled here: caught mons start at max friendship for instant evolutions, which under affection granted them +2 crit stage (near-constant crits) plus hidden dodge/survive/damage buffs. Friendship evolutions are unaffected by this flag.
