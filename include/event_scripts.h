...
extern const u8 gNameChoice_Locke[];
...
extern const u8 gOakSpeech_Text_RivalFlavor_Buhrito[];
extern const u8 gOakSpeech_Text_RivalFlavor_Twitch[];
extern const u8 gOakSpeech_Text_RivalFlavor_Locke[];
