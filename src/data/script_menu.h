...
#if defined(FIRERED)
    {COMPOUND_STRING("ABRA{CLEAR_TO 85}{FONT_SMALL} 1 COIN")},
    {COMPOUND_STRING("CLEFAIRY{CLEAR_TO 85}{FONT_SMALL} 1 COIN")},
    {COMPOUND_STRING("DRATINI{CLEAR_TO 75}{FONT_SMALL} 1 COIN")},
    {COMPOUND_STRING("SCYTHER{CLEAR_TO 75}{FONT_SMALL} 1 COIN")},
    {COMPOUND_STRING("PORYGON{CLEAR_TO 75}{FONT_SMALL} 1 COIN")},
#else
    {COMPOUND_STRING("ABRA{CLEAR_TO 85}{FONT_SMALL} 1 COIN")},
    {COMPOUND_STRING("CLEFAIRY{CLEAR_TO 85}{FONT_SMALL} 1 COIN")},
    {COMPOUND_STRING("PINSIR{CLEAR_TO 75}{FONT_SMALL} 1 COIN")},
    {COMPOUND_STRING("DRATINI{CLEAR_TO 75}{FONT_SMALL} 1 COIN")},
    {COMPOUND_STRING("PORYGON{CLEAR_TO 75}{FONT_SMALL} 1 COIN")},
#endif
    {sText_NoThanks}
...
static const struct MenuAction sMultichoiceList_GameCornerTMPrizes[] = {
    {COMPOUND_STRING("TM13{CLEAR_TO 72}{FONT_SMALL}1 COIN")},
    {COMPOUND_STRING("TM23{CLEAR_TO 72}{FONT_SMALL}1 COIN")},
    {COMPOUND_STRING("TM24{CLEAR_TO 72}{FONT_SMALL}1 COIN")},
    {COMPOUND_STRING("TM30{CLEAR_TO 72}{FONT_SMALL}1 COIN")},
    {COMPOUND_STRING("TM35{CLEAR_TO 72}{FONT_SMALL}1 COIN")},
    {COMPOUND_STRING("TM36{CLEAR_TO 72}{FONT_SMALL}1 COIN")},
    {COMPOUND_STRING("TM51{CLEAR_TO 72}{FONT_SMALL}1 COIN")},
    {sText_NoThanks}
};

static const struct MenuAction sMultichoiceList_GameCornerBattleItemPrizes[] = {
    {COMPOUND_STRING("SMOKE BALL{CLEAR_TO 90}{FONT_SMALL}1 COIN")},
    {COMPOUND_STRING("MIRACLE SEED{CLEAR_TO 80}{FONT_SMALL}1 COIN")},
    {COMPOUND_STRING("CHARCOAL{CLEAR_TO 80}{FONT_SMALL}1 COIN")},
    {COMPOUND_STRING("MYSTIC WATER{CLEAR_TO 80}{FONT_SMALL}1 COIN")},
    {COMPOUND_STRING("YELLOW FLUTE{CLEAR_TO 80}{FONT_SMALL}1 COIN")},
    {sText_NoThanks}
};
